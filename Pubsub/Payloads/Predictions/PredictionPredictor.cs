...
public class PredictionPredictor
{
    ...
    [JsonPropertyName("predicted_at")] public DateTimeOffset PredictedAt { get; set; }
    ...
    public PredictionPredictor(string id, int points, DateTimeOffset predictedAt, DateTimeOffset updatedAt,
